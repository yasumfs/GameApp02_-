...
public class TimeController12 : MonoBehaviour {
	...
	void Update () {
		...
		//クリア条件になったらtimer停止
		GameControllerMain12 game12 =Game.GetComponent<GameControllerMain12>();
